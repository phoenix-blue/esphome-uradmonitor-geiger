...
The current compact v7 base and lid are provided as print-ready STL files.
Editable STEP files are intentionally not included.
...
| `hardware/enclosure/` | Compact v7 base/lid STL files |
